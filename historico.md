# Histórico de posts — LinkedIn pessoal

Controle de temas publicados, pra não repetir e manter a proporção dos pilares ([[posicionamento]]).
Atualizado a cada lote gerado pela skill `linkedin-autoridade-semanal`.

| Data | Dia | Pilar | Formato | Tema (pauta nº) | Status |
|---|---|---|---|---|---|
| 22/09/2026 | Terça | Carreira e aprendizado (4) | Texto + imagem | Parar de esconder os 2 anos de experiência (38) | rascunho |
| 23/09/2026 | Quarta | IA aplicada ao marketing (1) | Carrossel PDF | Sistema de skills sem saber programar (1) | rascunho |
| 24/09/2026 | Quinta | Conteúdo & copy (2) | Texto + imagem | O teste que uso pra validar um gancho (22) | rascunho |
| 29/09/2026 | Terça | IA aplicada ao marketing (1) | Texto + imagem | Automação quebrou, debugar sem programar (4) | rascunho |
